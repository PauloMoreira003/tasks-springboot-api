...
import com.paulomoreira.task.domain.dto.ErrorDTO;
import com.paulomoreira.task.domain.dto.TaskDTO;
import com.paulomoreira.task.exception.TaskNotFoundException;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorDTO> handleValidationException(MethodArgumentNotValidException ex) {
        String errorMessage = ex.getBindingResult().getFieldErrors().stream().findFirst().map(DefaultMessageSourceResolvable::getDefaultMessage).orElse(
                "Validation Failed.");
